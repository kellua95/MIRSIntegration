        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Municipalities_Governorates_GovernorateId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Issues_AspNetUsers_AssignedEmployeeId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Issues_Governorates_GovernorateId",
                        column: x => x.GovernorateId,
                        principalTable: "Governorates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsVisibleToUser = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: true),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_IssueComments_AspNetUsers_CreatedByEmployeeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_IssueImages_AspNetUsers_UploadedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IssueComments_CreatedByEmployeeId",
                table: "IssueComments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IssueImages_UploadedByUserId",
                table: "IssueImages",
                column: "UploadedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Issues_AssignedEmployeeId",
                table: "Issues",
                column: "AssignedEmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_Issues_GovernorateId",
                table: "Issues",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Municipalities_GovernorateId",
